...
import static saka1029.tensuhyo.run.r0404.Commons.OLD_GENGO;
import static saka1029.tensuhyo.run.r0404.Commons.OLD_YEAR;
import static saka1029.tensuhyo.run.r0404.Commons.YEAR;
import static saka1029.tensuhyo.run.r0404.Commons.getLogger;
...
public class Test歯科区分一覧 {

	static final Logger logger = getLogger(Test歯科区分一覧.class.getName());
	...
	static final String TEN = "s";
	static final String TENSU = "歯科";

	static final String OLD_KOKUJI = BASE_DIR + OLD_YEAR + "/" + TEN + "/txt/告示";
	static final String OLD_ROOT_NAME = GENGO + OLD_YEAR + "年" + TENSU;
	...
	@Test
	public void 区分一覧出力() throws IOException, ParseException {
