...
//		w.printf("<script src='%s' type='text/javascript'></script>%n", Renderer.ALL_JS);
		...
		w.printf("<h1>%s</h1>%n", title);
		w.printf("<ul>%n");
		for (別添 e : list)
            w.printf("<li><a href='image/%s'>%s %s</a></li>%n",
